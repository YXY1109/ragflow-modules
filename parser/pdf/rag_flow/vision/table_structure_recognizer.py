...
class TableStructureRecognizer(Recognizer):
    ...
    def __init__(self):
        try:
            super().__init__(self.labels, "tsr", r"D:\PycharmProjects\ragflow\rag\res\deepdoc")
        except Exception:
            super().__init__(
                self.labels,
                "tsr",
                snapshot_download(
                    ...
                    local_dir=r"D:\PycharmProjects\ragflow\rag\res\deepdoc",
    ...
    def construct_table(boxes, is_english=False, html=True, **kwargs):
        ...
        for b in boxes[1:]:
            ...
            if lst_r[-1].get("R", "") != b.get("R", "") or (
                    b["top"] >= btm - 3 and lst_r[-1].get("R", "-1") != b.get("R", "-2")):  # new row
                btm = b["bottom"]
                b["rn"] += 1
                rows.append([b])
                continue
