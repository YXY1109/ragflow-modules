...
from nlp.rag_tokenizer import tokenize
from parser.excel.excel_parser import RAGFlowExcelParser
from parser.html.html_parser import RAGFlowHtmlParser
from parser.pdf.rag_flow.parser_config_utils import normalize_layout_recognizer
from parser.pdf.rag_flow.pdf_parser import RAGFlowPdfParser
...
def chunk(filename, binary=None, from_page=0, to_page=100000,
    ...
    if re.search(r"\.docx$", filename, re.IGNORECASE):
        ...
        callback(0.1, "Start to parse.")
        sections = RAGFlowHtmlParser()(filename, binary)
        sections = [s for s in sections if s]
        callback(0.8, "Finish parsing.")
