...
from .utils import get_completion, preprocess_json_response
...
class AutoQueryRewriter:
    ...
    def __init__(self, llm_model: str = "qwen-turbo-latest",
    ...
    def analyze_query_type(self, query: str, conversation_history: str = "") -> Dict[str, Any]:
        ...
        2. reference: 模糊指代
        3. comparison: 对比型
        4. context_dependent: 上下文依赖
        5. rhetorical: 反问型

        请输出JSON，字段包括 query_type, confidence, detected_keywords, reasoning。"""
        prompt = f"""
        ### 指令 ###
        {instruction}
