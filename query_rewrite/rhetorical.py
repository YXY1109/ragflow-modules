...
# 解析JSON        try:
            result = json.loads(preprocess_json_response(response))
return result
except Exception as e:
# 如果解析失败，返回原始Query            return {
"is_rhetorical": False,
"emotion": "neutral",
